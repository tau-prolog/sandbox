				...
				<div id="query-container">
					<div>
						<div class="header">Query
							...
							<span style="margin-left: 20px;" id="quoted-container" title="Stop when reaching the limit of inferences"><input type="checkbox" id="stop" name="stop" checked="checked"> <label for="stop">stop</label></span>
							<span style="margin-left: 10px;" id="quoted-container" title="Quoted"><input type="checkbox" id="quoted" name="quoted" checked="checked"> <label for="quoted">quoted</label></span>
